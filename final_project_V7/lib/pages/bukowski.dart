...
class _BukowskiState extends State<Bukowski> {
  ...
  List<Author> bukowski = new List<Author>();
  final authorBukowski = 'Bukowski';
  ...
  void initState() {
    ...
    WidgetsBinding.instance
        .addPostFrameCallback((_) => queryAuthor(authorBukowski));
  }
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Text(
                      '''
                        Name: ${bukowski[0].authorName}
                        Born: ${bukowski[0].authorBirth}
                        Nationality: ${bukowski[0].authorNationality}
                        Occupation:	${bukowski[0].authorOccupation}
                        FunFact: ${bukowski[0].authorFact}
                      ''',
                      style: TextStyle(
                        color: Colors.white,
  ...
  void queryAuthor(name) async {
    ...
    bukowski.clear();
    allRows.forEach((row) => bukowski.add(Author.fromMap(row)));
    setState(() {});
  }
}
